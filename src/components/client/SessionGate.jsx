...
import { UtensilsCrossed, Users, Clock, X, Check, QrCode, SmilePlus } from 'lucide-react'
...
export default function SessionGate({ status, ownerName, createSession, joinSession }) {
  ...
  const [step, setStep]           = useState(1) // 1=name, 2=party size
      ...
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className="text-neutral-400 text-sm">
            Esta mesa ya alcanzó su capacidad máxima.
          </p>
      ...
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          <div className="text-center mb-6">
            ...
            <p className="text-neutral-400 text-sm">Hola, <span className="text-white">{name}</span></p>
          </div>
